    ...
    <div class="card custom--card">
        <div class="card-body">
            <form action="{{ route('influencer.service.store', @$service->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group skill-body">
                    <label class="form-label" for="industry">@lang('Industry')</label>
                    <select class="form-select form--control" name="industry" id="industry" required>
                        <option value="" selected disabled>@lang('Select industry')</option>
                        @foreach ($industries as $industry)
                            <option value="{{ $industry->name }}" @if ($industryName == $industry->name) selected="selected" @endif>
                ...
                <div class="form-group skill-body">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control form--control" name="followers" id="followers" value="@if(@$service){{ @$service->followers }}@else{{ old('followers') }}@endif" required>
                    </div>
                </div>
                <div class="form-group skill-body">
                    <label class="form-label" for="location">@lang('Location')</label>
                    <input type="text" class="form-control form--control" name="location" id="location" value="@if (@$service) {{ @$service->location }}@else{{ old('location') }} @endif" required>
