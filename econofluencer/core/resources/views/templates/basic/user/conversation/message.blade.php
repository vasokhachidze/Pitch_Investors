    ...
    <div class="msg__item">
        <div class="post__creator">
            <div class="post__creator-content">
                ...
                <span class="comment-date text--secondary">{{ diffForHumans($conversation->created_at)
                    }}</span>
                @endif
                ...
                <div>
                    ...
                    <p class="m-1">
                        <a href="{{ route('attachment.download', [$attachment, $conversation->id, $type]) }}" class="me-2 text-white"><i
        ...
        <div class="post__creator">
            <div class="post__creator-content">
                ...
                <div>
                    @foreach (json_decode($conversation->attachments) as $key => $attachment)
                    <p class="m-1">
                        <a href="{{ route('attachment.download', [$attachment, $conversation->id, $type]) }}" class="me-2 text--base"><i
                                class="fa fa-file text--base"></i>
                            @lang('Attachment') {{ ++$key }}
                        </a>
                    </p>
