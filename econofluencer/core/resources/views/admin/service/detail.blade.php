            ...
            <div class="card b-radius--10 box--shadow1 overflow-hidden">
                <div class="card-body">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-12">
                            <h6 class="mb-2">@lang('Industry')</h6>
                            <p>{{ __(@$service->industry) }}</p>
                        </div>
                        <div class="col-md-12">
                            <h6 class="mb-2">@lang('Followers')</h6>
                            <p>{{ __(@$service->followers) }}</p>
                        </div>
                        <div class="col-md-12">
                            <h6 class="mb-2">@lang('Location')</h6>
                            <p>{{ __(@$service->location) }}</p>
                        </div>
                        <div class="col-md-12">
