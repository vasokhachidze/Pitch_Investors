...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageIndustryController')->name('industry.')->prefix('industry')->group(function () {
        Route::get('/', 'industry')->name('index');
        Route::post('/industry/{id?}', 'store')->name('add');
        Route::post('/delete/{id?}', 'delete')->name('delete');
    });
