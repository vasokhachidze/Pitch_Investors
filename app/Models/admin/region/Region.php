...
class Region extends Model
{
    ...
    protected $fillable = ['iRegionId', 'vUniqueCode', 'iCountryId', 'vTitle', 'eStatus', 'iAddedBy', 'iUpdatedBy', 'dtAddedDate', 'dtUpdatedDate', 'eIsDeleted'];
    ...
    public static function get_all_data($criteria = array(), $start = '', $limit = '', $paging = false){
        ...
        $SQL->Join("country", "country.iCountryId", "=", "region.iCountryId")
            ->select('region.*', 'country.vCountry as countryname');
