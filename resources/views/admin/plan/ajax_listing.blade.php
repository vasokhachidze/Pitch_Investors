...
<tr align="center" class="text-center">
	...
	<td class="white-space">
		<a class="btn btn-info btn-sm" href="{{url('admin/plan/edit',$value->vUniqueCode)}}"><i class="fas fa-pencil-alt"></i></a>
