                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools w-100">
                            <!-- used component -->
                            <x-table-layout : name="Admin" : url="admin/admin/add"/>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><input placeholder="Email" id="vEmail" type="text" name="email" class="search form-control"></th>
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $('#eIsDeleted').val('');
                        toastr.success('Admin Data recover Successfully.');
