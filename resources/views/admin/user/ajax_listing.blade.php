...
<tr align="center" class="text-center">
    ...
    <td>
        @if(!empty($value->vImage))
            <img alt="{{$value->vImage}}" class="img-fluid" style="height: 35px;" src="{{asset('uploads/user/'.$value->vImage)}}"></td>
        @else
            <img alt="no-image" class="img-fluid" style="height: 35px;" src="{{asset('front/assets/images/defaultuser.png')}}"></td>
        @endif
	...
	<td class="white-space">
		<a class="btn btn-info btn-sm" href="{{url('admin/user/edit',$value->vUniqueCode)}}"><i class="fas fa-pencil-alt"></i></a>
