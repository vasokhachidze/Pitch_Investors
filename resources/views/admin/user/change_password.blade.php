          ...
          <div class="card ">
            <div class="card-header">                              
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link" href="{{url('admin/user/edit',$vUniqueCode)}}">User</a></li>
                  <li class="nav-item"><a class="nav-link active" href="{{url('admin/user/change_password',$vUniqueCode)}}">Change Password</a></li>
                </ul>
            </div>
            <form action="{{url('admin/user/change_password_action')}}" name="frm" id="frm" method="post" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
