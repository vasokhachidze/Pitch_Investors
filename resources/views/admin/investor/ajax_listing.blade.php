...
<tr align="center" class="text-center">
    ...
    <td>
        @if(!empty($value->vInvestorDisplayId))
        {{$value->vInvestorDisplayId}}
        @else
        {{ "N/A" }}
        @endif
	...
	<td class="white-space">
		<a class="btn btn-info btn-sm" href="{{url('admin/investor/view',$value->vUniqueCode)}}"><i class="fas fa-eye"></i></a>
        <a class="btn btn-info btn-sm" href="{{url('admin/investor/edit',$value->vUniqueCode)}}"><i class="fas fa-pencil-alt"></i></a>
