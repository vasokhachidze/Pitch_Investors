                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools w-100">
                                <!-- used component -->
                                <x-table-layout : name="Testimonial" : url="admin/testimonial/add"/>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                <thead>
                                    <tr align="center" class="text-center">
                                        ...
                                        <th><input placeholder="Testimonial Name" id="vName" type="text" name="vName" class="search form-control"></th>
                                        <th><input placeholder="Testimonial Description" id="tDescription" type="text" name="tDescription" class="search form-control"></th>
...
<script>
    $(document).ready(function(){
        ...
        setTimeout(function() {
            $.ajax({
                url: "{{url('admin/testimonial/ajax_listing')}}",
                type: "POST",
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $('#eIsDeleted').val('');
                        toastr.success('Testimonial Data recover Successfully.');
