                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools w-100">
                               <!-- used component -->
                                <x-table-layout : name="Page Setting" : url="admin/pageSetting/add"/>
                            </div>
                        </div>
                        <div class="card-body">
...
<script>
    $(document).ready(function(){
        ...
        setTimeout(function() {
            $.ajax({
                url: "{{url('admin/pageSetting/ajax_listing')}}",
                type: "POST",
            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $("#ajax-loader").hide();
                        toastr.success('PageSetting Deleted Successfully.');
                    }
                });
            }, 1000);
        }
                ...
                setTimeout(function(){
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(eStatus == "delete"){
                                toastr.error('Page Setting Deleted Successfully.');
                            }
                            else{
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $('#eIsDeleted').val('');
                        toastr.success('Page Setting Data recover Successfully.');
