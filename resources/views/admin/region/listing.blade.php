                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools w-100">
                                <!-- used component -->
                                <x-table-layout : name="Region" : url="admin/region/add"/>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                <thead>
                                    <tr align="center" class="text-center">
                                        ...
                                        <th><input placeholder="Region Name" id="vTitle" type="text" name="vTitle" class="search form-control"></th>
...
<script>
    $(document).ready(function(){
        ...
        setTimeout(function() {
            $.ajax({
                url: "{{url('admin/region/ajax_listing')}}",
                type: "POST",
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(eStatus == "delete"){
                                ...
                                toastr.success('Region Update Successfully.');
                            }
                        }
                    });
                }, 1000);
            ...
            setTimeout(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $('#eIsDeleted').val('');
                        toastr.success('Region Data recover Successfully.');
