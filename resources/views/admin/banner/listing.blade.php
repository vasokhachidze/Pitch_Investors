                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools w-100">
                            <!-- used component -->
                            <x-table-layout : name="User" : url="admin/banner/add"/>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><input placeholder="vBannerTitle" id="vBannerTitle" type="text" name="vBannerTitle" class="search form-control"></th>
                                    <th><input placeholder="vSubTitle" id="vSubTitle" type="text" name="vSubTitle" class="search form-control"></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            $.ajax({
                url: "{{url('admin/banner/ajax_listing')}}",
                type: "POST",
