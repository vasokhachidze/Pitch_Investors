        		...
        		<div class="listing-page">
        			<div class="card">
        				<div class="card-header">
                            <!-- used component -->
                            <x-table-layout : name="System Email" : url="admin/system_email/add"/>
        					...
        					<table class="table table-bordered">
        						<thead>
        							<tr align="center" class="text-center">
                                        ...
                                        <th><input placeholder="Email Title" id="vEmailTitle" type="text" name="vEmailTitle" class="search form-control"></th>
                                        <th><input placeholder="Email Code" id="vEmailCode" type="text" name="vEmailCode" class="search form-control"></th>
            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#table_record").show();
                        $("#ajax-loader").hide();
                        toastr.success('System Email Deleted Successfully.');
                    }
                });
            }, 1000);
        }
