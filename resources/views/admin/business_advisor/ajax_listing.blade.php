...
<tr align="center" class="text-center">
    ...
    <td>
        @if(!empty($value->vAdvisorDisplayId))
        {{$value->vAdvisorDisplayId}}
        @else
        {{ "N/A" }}
        @endif
    </td>
	...
	<td class="white-space">
        <a class="btn btn-info btn-sm" href="{{url('admin/business-advisor/view',$value->vUniqueCode)}}"><i class="fas fa-eye"></i></a>
		<a class="btn btn-info btn-sm" href="{{url('admin/business-advisor/edit',$value->vUniqueCode)}}"><i class="fas fa-pencil-alt"></i></a>
