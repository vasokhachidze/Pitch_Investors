...
@section('title', 'Business Advisor Listing - '.env('APP_NAME'))
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools w-100">
                            <!-- used component -->
                            <x-table-layout : name="Business Advisor " : url="admin/business-advisor/add"/>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            $.ajax({
                url: "{{url('admin/business-advisor/ajax_listing')}}",
                type: "POST",
    ...
    $(document).on('keyup', '.search', function() {
        ...
        var vInvestorDisplayId           = $('#vInvestorDisplayId').val();
        var vName           = $('#vName').val();
        ...
        setTimeout(function() {
            $.ajax({
                ...
                data: {
                    keyword: keyword,
                    vInvestorDisplayId: vInvestorDisplayId,
                    vName: vName,
                    vEmail: vEmail,
                    vPhone: vPhone,
