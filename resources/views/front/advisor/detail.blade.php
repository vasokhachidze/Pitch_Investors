...
@section('title', 'Advisor Detail ' . env('APP_NAME'))
@section('content')
    @php
    ...
    <section class="bread-camp-detail lite-gray">
        <div class="container">
            <div class="bread-text-head">
                <h5><a href="{{ url('home') }}">Home </a>/<a href="{{ url('advisor') }}"> Advisor</a> /<a> {{ $data->vAdvisorProfileTitle }}</a></h5>
            </div>
        </div>
    </section>
    <!-- banner section end -->
        ...
        <div class="container">
            <div class="row sticky-detail">
                <div class="col-md-10">
                    <div class="detail-heading">
                        <h2 class="mb-1">{{ $data->vAdvisorProfileTitle }}</h2>
                    </div>
                </div>
                <div class="col-md-2">
                    <div>
                        @if (isset($loginUserId))
                            @php
                                ...
                                if (!empty($inInvestmentCheckProfile) || count($inInvestmentCheckProfile) > 0) {
                            ...
                            @elseif(($availableProfile == 'Yes' || $availableProfile2 == 'Yes') && !$myOwnProfile)
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#exampleModal1" class="btn btn-primary1 connection-btn-design green-btn">
                                    Send Proposal
                                </a>
                            @elseif(!$myOwnProfile)
                            ...
                            @endif
                        @else
                            <a href="{{ url('login') }}" class="btn btn-primary1 connection-btn-design green-btn">Contact Us</a>
                        @endif
                    </div>
                </div>
                <div class="col-md-12">
            ...
            <div class="detail-warp-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="detail-heading insight-name">
                            <p>{{ strip_tags($data->tAdvisorProfileDetail) }}</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="company-detail ul-with-dot">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="options">
                                        <ul>
                                            @if ($data->eFinancialAnalyst == 'Yes')
                                                <li> {{ 'Businesses Seeking advisor' }} </li>
                                            @endif
                                            @if ($data->eInvestmentBanks == 'Yes')
                                                <li> {{ 'Investment Banks' }} </li>
                                            @endif
                                            @if ($data->eMandAAdvisor == 'Yes')
                                                <li> {{ 'M&A Advisors' }} </li>
                                            @endif
                                            @if ($data->eBusinessBrokers == 'Yes')
                                                <li> {{ 'Business Brokers' }} </li>
                                            @endif
                                            @if ($data->eCommercialRealEstateBrokers == 'Yes')
                                                <li> {{ 'CRE Brokers' }} </li>
                                            @endif
                                            @if ($data->eTaxConsultant == 'Yes')
                                                <li> {{ 'Financial Consultants' }} </li>
                                            @endif
                                            @if ($data->eAccountant == 'Yes')
                                                <li> {{ 'Accountants' }} </li>
                                            @endif
                                            @if ($data->eBusinessLawer == 'Yes')
                                                <li> {{ 'Law Firms' }} </li>
                                            @endif
                                        </ul>
                                    </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="company-detail">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    @php
                                        $total_words_Bio = str_word_count($data->tBio);
                                        $desc1_Bio = $desc2_Bio = '';
                                        if ($total_words_Bio > 20) {
                                            $desc1_Bio = implode(' ', array_slice(explode(' ', $data->tBio), 0, 20));
                                            $desc2_Bio = implode(' ', array_slice(explode(' ', $data->tBio), 21));
                                        } else {
                                            $desc1_Bio = $data->tBio;
                                        }
                                    @endphp
                                    <div class="options">
                                        <ul>
                                            <li>
                                                {{ $desc1_Bio }}
                                                @if ($total_words_Bio > 20)
                                                    <span id="dots_Bio">...</span><span class="more_span" id="more_Bio">
                                                        {{ $desc2_Bio }}
                                                    </span>
                                                    <a onclick="read_more_less_text('dots_Bio','more_Bio','myBtn_businessHighLights')" id="myBtn_businessHighLights" class="text-green pointer_cursor">
                                                        Read more
                                                    </a>
                                                @endif
                                            </li>
                                    ...
                                    <div class="options">
                                        <ul>
                                            ...
                                            @foreach ($industries as $key => $ivalue)
                                                @if (!empty($ivalue->vIndustryName) && $ivalue->iAdvisorProfileId == $data->iAdvisorProfileId)
                                                    {{ $nullValue2 = '' }}
                        ...
                        <div class="col-md-12">
                            <div class="Seeking-detail mt-3">
                                ...
                                <div id="review_AddBox_Div" style="display:none;">
                                    <form id="reviewfrm" action="{{ url('advisor-review') }}" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" id="vUniqueCode" name="vUniqueCode" value="{{ $data->vUniqueCode }}">
                                        <input type="hidden" id="iAdvisorProfileId" name="iAdvisorProfileId" value="{{ $data->iAdvisorProfileId }}">
                                            ...
                                            <div class="detail-form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <textarea class="form-control" name="vReview" id="vReview" placeholder="Write a Review">
                                                            @if (isset($my_review_data->vReview))
                                                                {{ $my_review_data->vReview }}
                                                            @endif
                                                        </textarea>
                                                    </div>
                                                    <div class="row margin-left-button" id="submit">
                                                        <label class="save-detail mt-1"><a href="javascript:;" id="submit_review">
                                                                @if (!empty($my_review_data))
                                                                    {{ 'Edit' }}
                                                                @else
                                                                    {{ 'Save' }}
                                ...
                                @foreach ($review_data as $key => $review_value)
                                    @if (!empty($session_data))
                                        @if ($review_value->iUserId != $session_data['iUserId'])
                                            <div class="col-md-12">
                                                <div class="options">
                                                    Name : {{ $review_value->vFirstName }} {{ $review_value->vLastName }}
                                                    <br>
                                                    <section class='rating-widget'>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 mt-3">
                        ...
                        <div class="row right-text">
                            {{-- <div class="col-lg-3 col-md-3 col-sm-6 pad-bottom">
                            <div class="company-detail">
                                <div class="rating">
                                    <h2>Overall Rating</h2>
                                </div>
                            ...
                            <div class="company-detail">
                                <div class="other-info">
                                    <h2>Company</h2>
                                    <p style="display: none;"> Available after connect Company</p>
                                </div>
                                <div class="other-info-detail">
                                    <ul>
                                        <li><i class="far fa-clock"></i> Available after connect</li>
                                    </ul>
                                </div>
                            </div>
                        </div> --}}
                                ...
                                <div class="investment-other-detail">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="options">
                                                <ul>
                                                    <li>Between @if (!empty($value->vHowMuchInvest))
                ...
                @endif
                    ...
                    <div class="col-xl-12 col-lg-5 col-md-5"></div>
                    <form id="frm" action="{{ url('advisor-token-store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                                    ...
                                                    <div>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                @foreach ($inInvestmentCheckProfile as $key => $ivalue)
                                                                    <div class="form-check mt-3">
                                                                        <input class="form-check-input fillValue" id="Investment_name_{{ $key }}" name="profile_name" type="radio" value="{{ $ivalue->iUserId }}" data-name="{{ $ivalue->vBusinessProfileName }}" data-phone="{{ $ivalue->vPhone }}" data-type="Investment" data-profileid="{{ $ivalue->iInvestmentProfileId }}" data-contactname="{{ $ivalue->vFirstName }}">
                                                                        <label class="form-check-label" for="Investment_name_{{ $key }}">
                                                        ...
                                                        @if (!empty($inInvestorCheckProfile))
                                                            <div>
                                                                ...
                                                                <div class="form-check mt-3">
                                                                    <input class="form-check-input fillValue" id="Investor_name" name="profile_name" type="radio" value="{{ $inInvestorCheckProfile->iUserId }}" data-name="{{ $inInvestorCheckProfile->vInvestorProfileName }}" data-phone="{{ $inInvestorCheckProfile->vPhone }}" data-type="Investor" data-profileid="{{ $inInvestorCheckProfile->iInvestorProfileId }}" data-contactname="{{ $inInvestorCheckProfile->vFirstName }}">
                                                                    <label class="form-check-label" for="Investor_name">
