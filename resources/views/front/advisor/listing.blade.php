...
<section class="bread-camp advisor-bg">
  <div class="container">
    <div class="bread-text-head">
      <h4><a class="bread-tag-hover" href="{{ route('front.home') }}">Home</a> / Advisors</h4>
      <h1>Advisors</h1>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-12">
        ...
        <div class="bussines-sale-box pt-4">
          ...
          <div class="text-center" id="advisor-listing-ajax-loader">
...
<script>
  ...
  $(document).ready(function() {
    $("#advisor-listing-ajax-loader").show();
    setTimeout(function() {
      $.ajax({
        url: "{{url('front/advisor/ajax_listing')}}",
        type: "POST",
        headers: {
        ...
        success: function(response) {
          ...
          $("#advisor-listing-ajax-loader").hide();
        }
      });
    }, 1000);
  });
